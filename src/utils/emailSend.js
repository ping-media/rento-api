...
async function sendOtpByEmailForBooking(userId, stationId, bookingId, vehicleImage, vehicleName, stationName, BookingStartDateAndTime, BookingEndDateAndTime, bookingPrice, vehicleBasic, ) {
  try {

    const {firstName, lastName}= await User.findOne({userId})
