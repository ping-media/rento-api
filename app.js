...
const startServer = async () => {
  ...
  app.use(
    cors({ origin: ['http://localhost:3000', 'https://promise-web.pages.dev', 'http://127.0.0.1:5501', 'http://192.168.1.16:5173', 'http://192.168.1.16:5174',  'https://rento.indyside.com', 'http://localhost:3001', 'http://localhost:5173','http://localhost:5174', 'https://rent-moto-admin.vercel.app', 'https://rent-moto-admin-react.vercel.app'] })
  );
